...
function renderCart() {
    ...
    for (let i = 0; i < cartProduct.length; i++) {
        ...
        <tr class="hover:bg-slate-50 dark:hover:bg-gray-800/50 transition-colors duration-200">
            ...
            <td class="py-4 px-6 font-mono">${product.price} vnđ</td>
            <td class="py-4 px-6 font-mono font-semibold text-slate-900 dark:text-white td-thanhtien">${thanhTien} vnđ</td>
            <td class="py-4 px-6 text-center">
